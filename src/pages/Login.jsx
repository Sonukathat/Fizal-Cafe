...
const Login = () => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cream-50 via-cream-100 to-coffee-50 pt-24 pb-6 md:pb-12 px-4"
    >
      <motion.div
      ...
      >
        ...
        <p className="mt-6 md:mt-8 text-center text-coffee-700 text-sm md:text-base">
          ...
          <Link to="/register" className="text-coffee-800 hover:text-coffee-600 font-bold hover:underline">
            Register here
          </Link>
        </p>
